...
export enum ZeroXKeyErrorCodes {
  UNKNOWN = "UNKNOWN",
  ...
  TRON_SEND_TRANSACTION_ERROR = "TRON_SEND_TRANSACTION_ERROR",
  ...
  FETCH_LATEST_BOOT_PROOF_ERROR = "FETCH_LATEST_BOOT_PROOF_ERROR",
  VERIFY_LATEST_BOOT_PROOF_ERROR = "VERIFY_LATEST_BOOT_PROOF_ERROR",
...
export class ZeroXKeyError extends Error {
  constructor(
    message: string,
    public code?: ZeroXKeyErrorCodes,
    public cause?: unknown,
  ) {
    super(message);
    this.name = "ZeroXKeyError";
  }
}

export class ZeroXKeyNetworkError extends ZeroXKeyError {
  constructor(
    message: string,
