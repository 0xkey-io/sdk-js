...
export type definitions = {
  ...
  v1CreateTvcDeploymentIntent: {
     ...
     */
    nonce?: number;
    /** @description Optional encrypted pull secret to authorize ZeroXKey to pull the pivot container image. If your image is public, leave this empty. */
  ...
  v1VerifyOtpIntentV2: {
    ...
    otpId: string;
    /** @description Encrypted bundle containing the OTP code and a client-generated public key. ZeroXKey's secure enclaves will decrypt this bundle, verify the OTP code, and issue a new Verification Token. Encrypted using the target encryption key provided in the INIT_OTP activity result. */
