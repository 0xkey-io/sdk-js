...
export type v1Curve = "CURVE_UNSPECIFIED" | "CURVE_SECP256K1" | "CURVE_ED25519";
...
export type AuthProxyService_GetAccountResponse = {
  activity: v1Activity;
};

export type AuthProxyService_GetAccountBody = {
  timestampMs?: string;
  organizationId?: string;
};

export type AuthProxyService_GetAccountInput = {
  body: AuthProxyService_GetAccountBody;
};

export type AuthProxyService_OAuth2AuthenticateResponse = {
  activity: v1Activity;
};

export type AuthProxyService_OAuth2AuthenticateBody = {
  timestampMs?: string;
  organizationId?: string;
};

export type AuthProxyService_OAuth2AuthenticateInput = {
  body: AuthProxyService_OAuth2AuthenticateBody;
};

export type AuthProxyService_OAuthLoginResponse = {
  activity: v1Activity;
};

export type AuthProxyService_OAuthLoginBody = {
  timestampMs?: string;
  organizationId?: string;
};

export type AuthProxyService_OAuthLoginInput = {
  body: AuthProxyService_OAuthLoginBody;
};

export type AuthProxyService_InitOtpResponse = {
  activity: v1Activity;
};

export type AuthProxyService_InitOtpBody = {
  timestampMs?: string;
  organizationId?: string;
};

export type AuthProxyService_InitOtpInput = {
  body: AuthProxyService_InitOtpBody;
};

export type AuthProxyService_InitOtpV2Response = {
  activity: v1Activity;
};

export type AuthProxyService_InitOtpV2Body = {
  timestampMs?: string;
  organizationId?: string;
};

export type AuthProxyService_InitOtpV2Input = {
  body: AuthProxyService_InitOtpV2Body;
};

export type AuthProxyService_OtpLoginResponse = {
  activity: v1Activity;
};

export type AuthProxyService_OtpLoginBody = {
  timestampMs?: string;
  organizationId?: string;
};

export type AuthProxyService_OtpLoginInput = {
  body: AuthProxyService_OtpLoginBody;
};

export type AuthProxyService_OtpLoginV2Response = {
  activity: v1Activity;
};

export type AuthProxyService_OtpLoginV2Body = {
  timestampMs?: string;
  organizationId?: string;
};

export type AuthProxyService_OtpLoginV2Input = {
  body: AuthProxyService_OtpLoginV2Body;
};

export type AuthProxyService_VerifyOtpResponse = {
  activity: v1Activity;
};

export type AuthProxyService_VerifyOtpBody = {
  timestampMs?: string;
  organizationId?: string;
};

export type AuthProxyService_VerifyOtpInput = {
  body: AuthProxyService_VerifyOtpBody;
};

export type AuthProxyService_VerifyOtpV2Response = {
  activity: v1Activity;
};

export type AuthProxyService_VerifyOtpV2Body = {
  timestampMs?: string;
  organizationId?: string;
};

export type AuthProxyService_VerifyOtpV2Input = {
  body: AuthProxyService_VerifyOtpV2Body;
};

export type AuthProxyService_SignupResponse = {
  activity: v1Activity;
};

export type AuthProxyService_SignupBody = {
  timestampMs?: string;
  organizationId?: string;
};

export type AuthProxyService_SignupInput = {
  body: AuthProxyService_SignupBody;
};

export type AuthProxyService_SignupV2Response = {
  activity: v1Activity;
};

export type AuthProxyService_SignupV2Body = {
  timestampMs?: string;
  organizationId?: string;
};

export type AuthProxyService_SignupV2Input = {
  body: AuthProxyService_SignupV2Body;
};

export type AuthProxyService_GetWalletKitConfigResponse = {
  activity: v1Activity;
};

export type AuthProxyService_GetWalletKitConfigBody = {
  timestampMs?: string;
  organizationId?: string;
};

export type AuthProxyService_GetWalletKitConfigInput = {
  body: AuthProxyService_GetWalletKitConfigBody;
};
