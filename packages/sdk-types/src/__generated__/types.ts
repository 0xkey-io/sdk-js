...
export type ProxyTOAuth2AuthenticateResponse = {
  /** A ZeroXKey issued OIDC token to be used with the LoginWithOAuth activity */
  oidcToken: string;
};
...
export type ProxyTVerifyOtpV2Response = {
  /** Verification Token containing a unique id, expiry, verification type, contact signed by ZeroXKey's enclaves. Verification status of a user is updated when the token is consumed (in OTP_LOGIN requests) */
  verificationToken: string;
};
