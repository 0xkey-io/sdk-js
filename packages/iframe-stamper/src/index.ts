...
export enum IframeEventType {
  ...
  ZeroXKeyInitMessageChannel = "ZEROXKEY_INIT_MESSAGE_CHANNEL",
...
export class IframeStamper {
    ...
    return new Promise((resolve, reject) => {
      ...
      this.iframe.addEventListener("load", () => {
        ...
        this.iframe.contentWindow.postMessage(
          {
            type: IframeEventType.ZeroXKeyInitMessageChannel,
   ...
   * The bundle should be encrypted to ZeroXKey's Signer enclave's initial public key
   * Encryption should be performed with HPKE (RFC 9180).
