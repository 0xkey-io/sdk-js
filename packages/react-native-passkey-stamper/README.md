...
[![npm](https://img.shields.io/npm/v/@0xkey-io/react-native-passkey-stamper?color=%234C48FF)](https://www.npmjs.com/package/@0xkey-io/react-native-passkey-stamper)

This package contains a React Native passkey stamper. It uses [`react-native-passkey`](https://github.com/f-23/react-native-passkey) to do the heavy lifting. This stamper is meant to be used with [`@0xkey-io/http`](https://www.npmjs.com/package/@0xkey-io/http)

## Installation

- Install both [`react-native-passkey`](https://www.npmjs.com/package/react-native-passkey) and `@0xkey-io/react-native-passkey-stamper` (this package) in your React Native project.
...
```ts
import { createPasskey } from "@0xkey-io/react-native-passkey-stamper";
import { v4 as uuidv4 } from "uuid";

// Returns authenticator params that can be used with sub-org creation, user creation, etc.
const authenticatorParams = await createPasskey({
  // Won't be visible to users, this is the name of the ZeroXKey resource
...
```ts
import { PasskeyStamper } from "@0xkey-io/react-native-passkey-stamper";
