...
import { STAMP_HEADER_WEBAUTHN, createStampResult } from "./_kernel/stamping";

// Header name for a webauthn stamp
const stampHeaderName = STAMP_HEADER_WEBAUTHN;
...
export class WebauthnStamper {
  ...
  async stamp(payload: string) {
    ...
    return createStampResult(stampHeaderName, JSON.stringify(stamp));
  }
}
