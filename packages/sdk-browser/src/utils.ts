import { uint8ArrayFromHexString } from "@0xkey-io/encoding";
import {
  generateP256KeyPair,
...
import { pointDecode } from "@0xkey-io/api-key-stamper";
...
export const createEmbeddedAPIKey = async (
  ...
  const ZEROXKEY_HPKE_INFO = new TextEncoder().encode("0xkey_hpke");
