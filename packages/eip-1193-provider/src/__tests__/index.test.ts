...
import type { ZeroXKeyEIP1193Provider } from "../types";
...
describe("Test ZeroXKey EIP-1193 Provider", () => {
  let zeroXKeyClient: ZeroXKeyClient;
  let eip1193Provider: ZeroXKeyEIP1193Provider;
  ...
  // This section of tests is dedicated to verifying the functionality of the ZeroXKey EIP-1193 Provider.
