...
export class ZeroXKeyActivityError extends Error {
  ...
  constructor(input: {
    ...
    this.name = "ZeroXKeyActivityError";
...
export class ZeroXKeyActivityConsensusNeededError extends Error {
  ...
  constructor(input: {
    ...
    this.name = "ZeroXKeyActivityConsensusNeededError";
    this.activityId = activityId ?? undefined;
    this.activityStatus = activityStatus ?? undefined;
    this.activityType = activityType ?? undefined;
    this.cause = cause ?? undefined;
...
export function assertActivityCompleted(activity: TActivity) {
  ...
  if (activityStatus === "ACTIVITY_STATUS_CONSENSUS_NEEDED") {
    throw new ZeroXKeyActivityConsensusNeededError({
