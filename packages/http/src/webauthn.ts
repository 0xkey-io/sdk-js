...
const defaultSigningOptions: ZeroXKeyCredentialRequestOptions = {
  publicKey: {
...
async function getCredentialRequestOptions(
  payload: string,
  tkSigningOptions: ZeroXKeyCredentialRequestOptions = defaultSigningOptions,
...
export async function getWebAuthnAttestation(
  options: ZeroXKeyCredentialCreationOptions,
