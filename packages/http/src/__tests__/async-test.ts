...
const sampleCreatePrivateKeysInput: ZeroXKeyApi.TCreatePrivateKeysInput = {
  body: {
...
test("`withAsyncPolling` should throw a rich error when activity requires consensus", async () => {
  ...
  try {
    ...
    expect(error).toBeInstanceOf(ZeroXKeyActivityError);
    const richError = error as ZeroXKeyActivityError;
...
test("`withAsyncPolling` should also work with synchronous activity endpoints", async () => {
  const mutation = withAsyncPolling({
    request: ZeroXKeyApi.signTransaction,
  });
...
test("typecheck only: `withAsyncPolling` only works with mutations that return an activity", () => {
  // Legit ones
  withAsyncPolling({ request: ZeroXKeyApi.createApiKeys });
  withAsyncPolling({ request: ZeroXKeyApi.createInvitations });
  withAsyncPolling({ request: ZeroXKeyApi.createPolicy });
  withAsyncPolling({ request: ZeroXKeyApi.createPrivateKeys });
  withAsyncPolling({ request: ZeroXKeyApi.deleteApiKeys });
  withAsyncPolling({ request: ZeroXKeyApi.deleteInvitation });
  withAsyncPolling({ request: ZeroXKeyApi.deletePolicy });
  withAsyncPolling({ request: ZeroXKeyApi.signRawPayload });
  withAsyncPolling({ request: ZeroXKeyApi.signTransaction });
  withAsyncPolling({ request: ZeroXKeyApi.getActivity });

  // Invalid ones
  // @ts-expect-error
  withAsyncPolling({ request: ZeroXKeyApi.postGetOrganization });
  // @ts-expect-error
  withAsyncPolling({ request: ZeroXKeyApi.postGetPolicy });
  // @ts-expect-error
  withAsyncPolling({ request: ZeroXKeyApi.postGetUser });
  // @ts-expect-error
  withAsyncPolling({ request: ZeroXKeyApi.postGetActivities });
  // @ts-expect-error
  withAsyncPolling({ request: ZeroXKeyApi.postGetPolicies });
  // @ts-expect-error
  withAsyncPolling({ request: ZeroXKeyApi.postGetPrivateKeys });
  // @ts-expect-error
  withAsyncPolling({ request: ZeroXKeyApi.postGetUsers });
  // @ts-expect-error
  withAsyncPolling({ request: ZeroXKeyApi.postGetWhoami });
  // @ts-expect-error
  withAsyncPolling({ request: ZeroXKeyApi.postGetPrivateKey });
});
