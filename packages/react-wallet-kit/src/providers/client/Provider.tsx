...
export const ClientProvider: React.FC<ClientProviderProps> = ({
  ...
  const buildConfig = (
    ...
    return {
      ...
      importIframeUrl: config.importIframeUrl ?? "https://import.0xkey.com",
      exportIframeUrl: config.exportIframeUrl ?? "https://export.0xkey.com",
            ...
            if (evt?.type === "failed") {
              ...
              callbacks?.onError?.(
                new ZeroXKeyError(
                  ...
                  ZeroXKeyErrorCodes.WALLET_CONNECT_INITIALIZATION_ERROR,
                  evt.error,
                ),
              );
  ...
  const refreshWallets = useCallback(
    async (params?: RefreshWalletsParams): Promise<Wallet[]> => {
      ...
      const walletProviders = await withZeroXKeyErrorHandling(
        ...
        async () => {
          ...
          if (!matchedAccount) {
            throw new ZeroXKeyError(
              ...
              ZeroXKeyErrorCodes.NO_WALLET_FOUND,
            );
          }
  ...
  const handleUpdateUserName = useCallback(
    async (params?: HandleUpdateUserNameParams): Promise<string> => {
      ...
      try {
        ...
        throw new ZeroXKeyError(
          "Failed to update user name.",
          ZeroXKeyErrorCodes.UPDATE_USER_NAME_ERROR,
          error,
        );
      }
    },
    ...
    async (params?: HandleUpdateUserPhoneNumberParams): Promise<string> => {
      ...
      if (!masterConfig.auth?.methods?.smsOtpAuthEnabled) {
        throw new ZeroXKeyError(
          ...
          ZeroXKeyErrorCodes.AUTH_METHOD_NOT_ENABLED,
        );
      }
    ...
    async (params?: HandleAddPasskeyParams): Promise<string[]> => {
      ...
      try {
        ...
        throw new ZeroXKeyError(
          ...
          ZeroXKeyErrorCodes.ADD_PASSKEY_ERROR,
          error,
        );
      }
    },
    ...
    async (
      ...
      if (!masterConfig?.walletConfig?.features?.connecting) {
        throw new ZeroXKeyError(
          ...
          ZeroXKeyErrorCodes.FEATURE_NOT_ENABLED,
        );
      }
  ...
  const handleRemoveUserEmail = useCallback(
    async (params?: HandleRemoveUserEmailParams): Promise<string> => {
      ...
      try {
        ...
        throw new ZeroXKeyError(
          "Failed to remove user email.",
          ZeroXKeyErrorCodes.UPDATE_USER_EMAIL_ERROR,
          error,
        );
      }
    },
  ...
  const handleVerifyAppProofs = useCallback(
    async (params: HandleVerifyAppProofsParams): Promise<void> => {
      ...
      try {
        ...
        throw new ZeroXKeyError(
          "Failed to verify app proofs.",
          ZeroXKeyErrorCodes.VERIFY_APP_PROOFS_ERROR,
          error,
        );
      }
    },
