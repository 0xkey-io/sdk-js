...
type TConfig = {
  ...
  /**
   * ZeroXKey wallet account public key or private key ID
   */
  signWith: string;
};
...
export class ZeroXKeyDirectWallet implements OfflineDirectSigner {
  public static async init(input: {
    config: TConfig;
    prefix?: string | undefined;
  }): Promise<ZeroXKeyDirectWallet> {
    ...
    return new ZeroXKeyDirectWallet({
      config,
      compressedPublicKey,
      prefix,
    });
