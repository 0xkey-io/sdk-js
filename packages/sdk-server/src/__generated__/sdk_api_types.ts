...
export type TTronSendTransactionResponse = operations["PublicApiService_TronSendTransaction"]["responses"]["200"]["schema"]["activity"]["result"]["tronSendTransactionResult"] & definitions["v1ActivityResponse"];

export type TTronSendTransactionInput = { body: TTronSendTransactionBody };

export type TTronSendTransactionBody = operations["PublicApiService_TronSendTransaction"]["parameters"]["body"]["body"]["parameters"] & commandOverrideParams;
