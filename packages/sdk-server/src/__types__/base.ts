import type { Runtime } from "@0xkey-io/api-key-stamper";
import type {
  TActivityId,
  TActivityStatus,
  ZeroXKeyApiTypes,
} from "@0xkey-io/http";
import type { WalletType } from "@0xkey-io/wallet-stamper";
...
export interface ZeroXKeySDKServerConfig {
  apiBaseUrl: string;
...
export interface ZeroXKeyProxyHandlerConfig {
...
export type CreateOauthProvidersResponse =
  ZeroXKeyApiTypes["v1CreateOauthProvidersResult"];
...
export type EmailCustomization = ZeroXKeyApiTypes["v1EmailCustomizationParams"];
