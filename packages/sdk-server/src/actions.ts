...
import { ZeroXKeyServerSDK } from "./sdk-client";
import {
  DEFAULT_ETHEREUM_ACCOUNTS,
  DEFAULT_SOLANA_ACCOUNTS,
} from "./0xkey-helpers";
import { WalletType } from "@0xkey-io/wallet-stamper";
...
export async function sendCredential(
  ...
  try {
    ...
    const response = await zeroXKeyClient.apiClient().emailAuth({
      email: request.email,
...
export async function sendOtp(
  ...
  try {
    const response = await zeroXKeyClient.apiClient().initOtp({
...
export async function verifyOtp(
  ...
  try {
    const response = await zeroXKeyClient.apiClient().verifyOtp({
      otpId: request.otpId,
...
export async function otpLogin(
  ...
  try {
    const response = await zeroXKeyClient.apiClient().otpLogin({
      organizationId: request.suborgID,
...
export async function oauthLogin(
  ...
  try {
    const response = await zeroXKeyClient.apiClient().oauthLogin({
      organizationId: request.suborgID,
...
export async function createOauthProviders(
  ...
  try {
    const response = await zeroXKeyClient.apiClient().createOauthProviders({
...
export async function getUsers(
  ...
  try {
    const response = await zeroXKeyClient.apiClient().getUsers({
      organizationId: request.organizationId,
    });
...
export async function getSuborgs(
  ...
  const response = await zeroXKeyClient.apiClient().getSubOrgIds({
    organizationId: zeroXKeyClient.config.defaultOrganizationId,
...
export async function getVerifiedSuborgs(
  ...
  const response = await zeroXKeyClient.apiClient().getVerifiedSubOrgIds({
    organizationId: zeroXKeyClient.config.defaultOrganizationId,
    filterType: request.filterType,
    filterValue: request.filterValue,
  });
...
export async function createSuborg(
  ...
  try {
    const response = await zeroXKeyClient.apiClient().createSubOrganization({
