...
This example shows how to use a ZeroXKey wallet to interact with Aave v3 on Base mainnet, supplying and withdrawing USDC. It provides the following scripts:
...
On top of it, we showcase the power of the ZeroXKey policy engine by allowing a non-root ZeroXKey user to only sign the specific transactions to the USDC and Aave Pool contract addresses:
