...
import { v1PrivateKey } from "@0xkey-io/sdk-types";

// Constants
const IFRAME_CONTAINER_ID = "0xkey-export-and-sign-iframe-container-id";
const IFRAME_ELEMENT_ID = "0xkey-default-iframe-element-id";
