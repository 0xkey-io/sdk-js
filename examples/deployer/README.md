...
This example shows how to deploy a smart contract using [`Ethers`](https://docs.ethers.org/v6/api/providers/#Signer) with ZeroXKey.
...
2. Deploy the contract via ZeroXKey signer
