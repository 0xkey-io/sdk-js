  ...
  return (
    <div className={`mt-8 ${isMobile ? "w-full" : "w-96"}`}>
      <div className="mt-6 mb-5 flex flex-col items-center gap-3">
        ...
        <div className="p-2 overflow-y-auto zeroxkey-scrollbar h-full mt-2 max-h-40 rounded-md border border-modal-background-dark/10 dark:border-modal-background-light/10 bg-icon-background-light dark:bg-icon-background-dark text-icon-text-light dark:text-icon-text-dark">
