...
import { ZeroXKeySigner } from "./signer";
...
interface PSBTCreationResult {
  zeroXKeyClient: ZeroXKeyServerSDK;
...
async function main() {
  ...
  if (addressType === "MainnetP2TR" || addressType === "TestnetP2TR") {
    ...
    signer = new ZeroXKeySigner(zeroXKeyClient, bitcoinAddress, pair.publicKey);
  }
