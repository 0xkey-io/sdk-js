...
This example shows how to send an SPL token on Solana using ZeroXKey's paymaster (fee sponsorship).
...
- Requests ZeroXKey fee sponsorship by setting `sponsor: true` in `solSendTransaction`
