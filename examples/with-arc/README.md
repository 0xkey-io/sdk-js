...
This example shows how to construct and broadcast a transaction on the Arc testnet using ZeroXKey.
...
The script constructs a transaction via ZeroXKey and broadcasts through Arc's provided testner RPC.
