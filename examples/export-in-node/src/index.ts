...
async function main() {
  ...
  if (exportType == "wallet") {
    ...
    exportResult = await zeroXKeyClient.apiClient().exportWallet({
      walletId,
    ...
    exportResult = await zeroXKeyClient.apiClient().exportPrivateKey({
      privateKeyId,
      targetPublicKey: publicKey,
    });
    ...
    exportResult = await zeroXKeyClient.apiClient().exportWalletAccount({
      address,
      targetPublicKey: publicKey,
    });
  } else {
