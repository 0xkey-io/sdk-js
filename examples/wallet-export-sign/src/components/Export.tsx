...
const ZeroXKeyIframeContainerId = "0xkey-export-and-sign-iframe-container-id";
const ZeroXKeyIframeElementId = "0xkey-export-and-sign-iframe-element-id";
...
export function Export(props: ExportProps) {
  ...
  // message + signature
  const [message, setMessage] = useState<string>("Hello, ZeroXKey!");
