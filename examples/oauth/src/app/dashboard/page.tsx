...
export default function Dashboard() {
  ...
  >(undefined);
  // --- Sign Message ---
  const [message, setMessage] = useState("Hello from ZeroXKey 👋");
  ...
  const onSendEth = async () => {
    try {
      ...
      // TODO: re-enable when getWalletAddressBalances is supported by the backend
  ...
  const onSendSol = async () => {
    try {
      ...
      // ZeroXKey replaces it with a fresh one at broadcast time when sponsor=true.
