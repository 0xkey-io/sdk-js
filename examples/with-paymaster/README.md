...
This example shows how to send an erc-20 token on evm networks using ZeroXKey's paymaster (gas sponsorship).
...
- Requests ZeroXKey sponsorship by setting `sponsor: true` and `gasStationNonce`
