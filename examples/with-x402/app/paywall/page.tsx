...
export default function PaymentClient() {
  const {
    ...
    session,
    wallets,
    httpClient, // @0xkey-io/viem needs a ZeroXKey HTTP client to access the ZeroXKey API
    handleLogin,
    logout,
  } = useZeroXKey();
  ...
  // The signing code below creates an EIP-3009 TransferWithAuthorization signature using ZeroXKey's Viem integration.
  ...
  const handlePayment = async () => {
    ...
    try {
      // This code was adapted from ZeroXKey's with-viem example. See examples/with-viem/src/eip712/erc3009_transfer.ts for the example.

      // Create ZeroXKey Viem account
      ...
      // Sign the typed data using ZeroXKey
          ...
          {authState === AuthState.Unauthenticated ? (
            <div className="space-y-4">
              <p className="text-gray-600">
                Please sign in with ZeroXKey to make the payment using your
                embedded wallet.
              </p>
              <button
                onClick={() => handleLogin()}
            ...
            <div className="space-y-4">
              <div className="gap-1 flex flex-col">
                <p className="text-gray-600">
                  ZeroXKey user name: {user?.userName || "User"}
                </p>
                <div className="flex flex-row gap-2 items-center">
                  <p className="text-gray-600">
                    {"ZeroXKey wallet address: "}
                ...
                <p className="text-gray-600 text-xs italic mt-1">
                  Want to use a different ZeroXKey sub-organization?{" "}
                  <button
              ...
              <div className="flex flex-col gap-2 justify-center items-center">
                ...
                >
                  {loading
                    ? "Processing payment..."
                    : "Pay 0.01 USDC with ZeroXKey Wallet"}
                </button>
