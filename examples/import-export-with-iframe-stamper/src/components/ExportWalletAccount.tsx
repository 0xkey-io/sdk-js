    ...
    <div className={styles.modalInner}>
      <div className={styles.modalDetails}>
            ...
            <ul>
              <li>
                <p>
                  ...
                  the ZeroXKey team. ZeroXKey will never ask you for your
                  private key.
                </p>
              </li>
              <li>
                <p>
                  ...
                  any assets associated with it, and ZeroXKey cannot help
                  recover it on your behalf. Failure to properly secure your
                  private key may result in total loss of the associated assets.
                </p>
              </li>
              <li>
                <p>
                  ZeroXKey is not responsible for any other wallet you may use
                  with this private key, and ZeroXKey does not represent that
                  any other software or hardware will be compatible with or
              ...
              <li>
                <p>
                  ...
                  <a href="https://www.0xkey.com/files/terms-of-service.pdf">
                    ZeroXKey{"'"}s Terms of Service
                  </a>
        ...
        <Export
          ...
          zeroXKeyBaseUrl={process.env.NEXT_PUBLIC_BASE_URL!}
        />
      </div>
    </div>
  );
