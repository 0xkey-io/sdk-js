...
This example includes API stubs to make a `whoami` request, fetch your wallets, as well as import and export wallets using a mnemonic phrase. The creation of the iframe is abstracted by our `@0xkey-io/iframe-stamper` package.
