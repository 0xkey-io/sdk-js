...
This example shows how to implement [external wallet authentication](https://docs.0xkey.com/sdks/react/using-external-wallets/overview) (e.g. MetaMask, Phantom, etc) with ZeroXKey using the [@0xkey-io/react-wallet-kit](https://docs.0xkey.com/sdks/react).
